                ...
                ;(qe && qe === e) ||
                    ...
                    (We =
                        'ADD_URI_SAFE_ATTR' in e
                            ? _(E(Be), e.ADD_URI_SAFE_ATTR)
                            : Be),
                    (Pe =
                        'ADD_DATA_URI_TAGS' in e
                            ? _(E(Ge), e.ADD_DATA_URI_TAGS)
                            : Ge),
                    ...
                    e.ADD_TAGS &&
                        (ve === be && (ve = E(ve)), _(ve, e.ADD_TAGS)),
                    e.ADD_ATTR &&
                        (Te === Ae && (Te = E(Te)), _(Te, e.ADD_ATTR)),
        ...
        n.isSupported &&
            (function () {
                try {
                    ...
                    A(/<\/title/, e.querySelector('title').innerHTML) &&
                        (a = !0)
                } catch (e) {}
            })()
        var Je = function (e) {
            ...
            tt = function (e) {
                var t = void 0
                if ((et('beforeSanitizeElements', e, null), Qe(e)))
                    return Ye(e), !0
                if (h(e.nodeName, /[\u0080-\uFFFF]/)) return Ye(e), !0
                var r = g(e.nodeName)
                if (
            ...
            ot = function e(t) {
                var n = void 0,
                    r = Je(t)
                for (
                    et('beforeSanitizeShadowDOM', t, null);
                    (n = r.nextNode());

                )
                    et('uponSanitizeShadowNode', n, null),
                        tt(n) || (n.content instanceof c && e(n.content), rt(n))
        ...
        return (
            (n.sanitize = function (e, r) {
                var o = void 0,
                    ...
                    u = void 0
                if (
                    (e || (e = '\x3c!--\x3e'), 'string' != typeof e && !Ze(e))
                ) {
                ...
                if (!n.isSupported) {
                    if (
                        ...
                        if (Ze(e)) return t.toStaticHTML(e.outerHTML)
                    }
                    return e
                }
                if (
                    ...
                    (1 ===
                        (a = (o = $e('\x3c!--\x3e')).ownerDocument.importNode(
                            e,
                            !0
                        )).nodeType &&
                        'BODY' === a.nodeName) ||
            ...
            (n.addHook = function (e, t) {
                'function' == typeof t && ((ue[e] = ue[e] || []), m(ue[e], t))
            }),

                    ...
                    return (
                            ...
                            e('body').hasClass(f) &&
                                ...
                                0 === i && 0 === n
                                    ? (e(o).css('bottom', t.footer),
                                      ...
                                      e(o + ', ' + o + ' ' + a).css('height', t.window - (t.header + t.footer)))
                                    : n <= t.footer
                                    ? !1 === r
                                        ? (e(o).css('bottom', t.footer - n), e(o + ', ' + o + ' ' + a).css('height', t.window - (t.footer - n)))
                                        : e(o).css('bottom', t.footer)
                                    : i <= t.header
                                    ? !1 === s
                                        ? (e(o).css('top', t.header - i), e(o + ', ' + o + ' ' + a).css('height', t.window - (t.header - i)))
                                        : e(o).css('top', t.header)
                                    : !1 === s
                                    ? (e(o).css('top', 0), e(o + ', ' + o + ' ' + a).css('height', t.window))
                                    : e(o).css('top', t.header))
                        }),
                        ...
                        (t._jQueryInterface = function(i) {
                            return this.each(function() {
                                var s = e(this).data(n)
                                if ((s || ((s = new t(this, e(this).data())), e(this).data(n, s)), 'undefined' === s[i]))
                    ...
                    return (
                        (n.collapse = function() {
                            ...
                            this._parent.children(a.CARD_BODY + ', ' + a.CARD_FOOTER).slideUp(this._settings.animationSpeed, function() {
                                ...
                                this._parent
                                    .find(this._settings.collapseTrigger + ' .' + this._settings.collapseIcon)
                        ...
                        (t._jQueryInterface = function(n) {
                            ...
                            i || ((i = new t(e(this), i)), e(this).data('lte.cardwidget', 'string' == typeof n ? i : n)),
                                'string' == typeof n && n.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/)
                                    ? i[n]()
                    ...
                    return (
                        ...
                        (t._jQueryInterface = function(n) {
                            var i = e(this).data('lte.cardrefresh'),
                                s = e(this).data()
                            i || ((i = new t(e(this), s)), e(this).data('lte.cardrefresh', 'string' == typeof n ? i : n)),
